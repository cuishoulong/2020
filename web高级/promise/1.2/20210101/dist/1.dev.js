...
var api3 = function api3() {
  return new Promise(function (resolve) {
    $.ajax({
      url: '/api3',
      success: function success(result3) {
        resolve(result3);
      }
    });
  });
  ...
  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return regeneratorRuntime.awrap(api1());

        case 2:
          result1 = _context.sent;
          _context.next = 5;
          return regeneratorRuntime.awrap(api2());

        case 5:
          result2 = _context.sent;
          _context.next = 8;
          return regeneratorRuntime.awrap(api3());
